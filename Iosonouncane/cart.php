...
//mysql_connect('localhost','root','davide','mvc') or die(mysql_error());
        ...
        while ($get_row = mysql_fetch_assoc($get)) {
            echo '<p>'.$get_row['product_id'].')&nbsp;&nbsp;'.$get_row['product_name']
                .'<br />'.$get_row['product_description'].'<br /> &euro;'.number_format($get_row['product_price'], 2).'
                    <a href="cart.php?add='.$get_row['product_id'].'">Aggiungi</a></p>';
        }
    }
}    
            ...
            if(substr($name, 0, 5) == 'cart_'){
              ...
              while($get_row = mysql_fetch_assoc($get)){
                  ...
                  echo $get_row['product_name'].' x '.$value.' @  &euro;'.number_format($get_row['product_price'], 2).' = 
                      &euro;'.number_format($sub, 2).'<a href="cart.php?remove='.$id.'"</a> [-] <a href="cart.php?add='.$id.'"> [+]</a> <a href="cart.php?delete='.$id.'"> [Delete]  </a> <br /> ';
              }
